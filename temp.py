...
third row:['{gm7}', '{gm8}', '{gm9}']"
    ...
    prompt_llm = PromptTemplate(
        ...
        make a move based on the current board state: {board_state}. DO NOT MOVE TO A SPACE ALREADY TAKEN\
        ONLY RETURN A NUMBER 1 to 9 that represents your move. Only return moves that are available\
            available moves are represented by:'*'"
    )
