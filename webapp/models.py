...
class Game(db.Model):
    ...
    str_move_1 = db.Column(db.String(1), default="*")
    str_move_2 = db.Column(db.String(1), default="*")
    str_move_3 = db.Column(db.String(1), default="*")
    str_move_4 = db.Column(db.String(1), default="*")
    str_move_5 = db.Column(db.String(1), default="*")
    str_move_6 = db.Column(db.String(1), default="*")
    str_move_7 = db.Column(db.String(1), default="*")
    str_move_8 = db.Column(db.String(1), default="*")
